 ...
 * @author bruno.bencke
 */
public class JdlGrafico extends javax.swing.JDialog {
    
    ProdutosDao pDao = new ProdutosDao();

    public JdlGrafico(java.awt.Frame parent, boolean modal) {        
        super(parent, modal);        
        initComponents();    
        this.jpnGrafico.setLayout(new BorderLayout());
        ArrayList<Produto> listaDeProdutos = pDao.retornaTodosProdutos();
        GraficoBarras graficoBarras = new GraficoBarras();        
        this.jpnGrafico.add(graficoBarras.criarGrafico(listaDeProdutos));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JdlGrafico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JdlGrafico dialog = new JdlGrafico(new javax.swing.JFrame(), true);
